...
export const genshinCharacters = [
    ...
    { name: "Sayu", element: "Anemo", stars: 4, weaponType: "claymore", img: "assets/characters/Sayu.png",
        ...
        items: [
            { name: "Coming Soon", img: "ruta/a/imagen/Coming Soon.png" },
            { name: "Coming Soon", img: "ruta/a/imagen/Coming Soon.png" }
        ],
        weapons: [
            { name: "Coming Soon", img: "ruta/a/imagen/espada_de_fuego.png" },
            { name: "Coming Soon", img: "ruta/a/imagen/espada_legendaria.png" }
        ],
        artifacts: [
            { name: "Coming Soon", img: "ruta/a/imagen/artefacto1.png" },
            { name: "Coming Soon", img: "ruta/a/imagen/artefacto2.png" }
        ]
    },
    { name: "Lynette", element: "Anemo", stars: 4, weaponType: "sword", img: "assets/characters/Lynette.png",
             reloj: "Coming Soon", caliz: "Coming Soon", corona: "Coming Soon", subs: "Coming Soon",
        items: [
            { name: "Coming Soon", img: "ruta/a/imagen/objeto1.png" },
            { name: "Coming Soon", img: "ruta/a/imagen/objeto2.png" }
        ],
        weapons: [
    ...
    { name: "Faruzán", element: "Anemo", stars: 4, weaponType: "catalyst", img: "assets/characters/Faruzan-new.png",
        ...
        weapons: [
            { name: "Coming Soon", img: "ruta/a/imagen/caliz_de_viento.png" }
        ],
        artifacts: [
            { name: "Coming Soon", img: "ruta/a/imagen/artefacto1.png" }
        ]
    ...
    { name: "Heizou", element: "Anemo", stars: 4, weaponType: "catalyst", img: "assets/characters/Heizou-new.png",
        ...
        weapons: [
            { name: "Coming Soon", img: "ruta/a/imagen/varita_del_viento.png" }
        ],
        artifacts: [
            { name: "Coming Soon", img: "ruta/a/imagen/artefacto1.png" }
        ]
